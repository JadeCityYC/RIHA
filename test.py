...
import numpy as np
import json
from modules.text_tokenizers import Tokenizer
...
def parse_agrs():
    ...
    parser.add_argument('--low_level_weight', type=float, default=0.6,
                        help='weight for low-level feature alignment')
    parser.add_argument('--mid_level_weight', type=float, default=0.3,
                        help='weight for mid-level feature alignment')
    parser.add_argument('--high_level_weight', type=float, default=0.1,
